...
// The AuthProvider has been moved to the specific layouts that need it,
// such as (mobile)/layout.tsx and (admin)/layout.tsx, to avoid context conflicts and build errors.
